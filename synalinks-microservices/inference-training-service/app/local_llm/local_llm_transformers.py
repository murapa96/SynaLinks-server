...
class LocalLLMTransformers(BaseModel):
    """
    Local LLM model that use transformers from huggingface
    """
    ...
    def generate(
        ...
        for stop in stop_list:
            stop_tokens_list.append(self.tokenizer.encode(stop))
        outputs = self.model.generate(
            **inputs,
            max_length = max_tokens,
            stopping_criteria = [EosListStoppingCriteria(stop_tokens_list)])
